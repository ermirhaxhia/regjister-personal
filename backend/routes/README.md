...
- reading.py — CRUD /books (tabela books; pages_read/pct_complete/sessions_count/pages_per_day/estimated_finish llogariten në Python nga reading_sessions; pages_per_day/estimated_finish vetëm me ≥2 sesione dhe status='reading'; listë e renditur 'reading' para 'finished', pastaj updated_at); nested CRUD /books/{id}/sessions (reading_sessions, FK cascade); çdo shkrim/fshirje sesioni thërret _sync_habit_log që mban minutat totale të datës në habit_log për çdo zakon tracking_type='lexim'
