...
-- ============================================================================
-- MODULI 8 — ORË PUNE (work_sessions)
...
-- Kohëzgjatja llogaritet automatikisht nga DB (EXTRACT EPOCH), si te sleep_log.
-- "Vendi i punës" lidhet me `sectors` (tabela e Modulit 6, jo tabelë e re).
-- ============================================================================
